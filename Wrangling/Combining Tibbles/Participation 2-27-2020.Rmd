...
```{r}
nycflights13::flights %>% 
  full_join(nycflights13::airlines, by = "carrier") %>% 
  full_join(nycflights13::airports, by = "") %>% 
  full_join(nycflights13::weather, by = c("year", "month", "day")) %>% 
  full_join(nycflights13::planes, by = "")
```
